				...
				<div className="relative overflow-hidden rounded-[2rem] border border-white/20 bg-white/10 p-6 shadow-[0_30px_90px_-30px_rgba(59,130,246,0.55)] backdrop-blur-2xl sm:p-8">
					...
					<div className="relative text-center">
						...
						<div className="mt-6 flex flex-wrap items-center justify-center gap-2 text-xs text-slate-100">
							<span className="rounded-full border border-emerald-300/30 bg-emerald-300/12 px-3 py-1 shadow-[0_0_18px_rgba(16,185,129,0.16)]">Whatever is easiest</span>
							<span className="rounded-full border border-sky-300/30 bg-sky-300/12 px-3 py-1 shadow-[0_0_18px_rgba(56,189,248,0.16)]">Quick on mobile</span>
						</div>
					</div>
