                    ...
                    <div>
                        ...
                        <div className="space-y-6 mb-8">
                            <a
                                ...
                                className="card p-6 flex items-center group hover:shadow-lg transform hover:-translate-y-1 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-200"
                                aria-label="Email sm4j@icloud.com"
                            >
                                ...
                                <div>
                                    <h3 className="font-semibold text-gray-800 group-hover:text-green-600 transition-colors duration-150">Email</h3>
                            ...
                            >
                                ...
                                <div>
                                    <h3 className="font-semibold text-gray-800 group-hover:text-green-600 transition-colors duration-150">LinkedIn</h3>
                            ...
                            >
                                ...
                                <div>
                                    <h3 className="font-semibold text-gray-800 group-hover:text-green-600 transition-colors duration-150">GitHub</h3>
